...
theory "Kleene_Algebra_Bench_Mirabelle_cyfzrlxhql"
  imports "out/Kleene_Algebra_Bench_Setup" Dioid
begin
...
lemma star_inductl_var_equiv: "x\<cdot>y \<le> y \<longleftrightarrow> x\<^sup>\<star>\<cdot>y \<le> y"
  apply (metis add_lub eq_iff mult_assoc mult_isor mult_onel star_inductl star_unfoldl)
  oops
