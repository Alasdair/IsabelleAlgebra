...
text {* I now consider which additional statements from Jule's note
...
(*
lemma omega_1_eq: "x\<^sup>\<omega>\<cdot>y = x\<^sup>\<omega>"
nitpick --- 2-element counterexample (clash with right zero axiom)
*)
